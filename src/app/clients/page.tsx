...
import { ClientListView, type ClientRow, type ClientWorkflow } from './ClientListView';

/**
 * Client List — the master view of every prospect and client.
 *
      ...
      <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        <main className="app-shell-main" style={{ flex: 1 }}>
          <div style={{ maxWidth: 1100, margin: '0 auto' }}>
            ...
            <ClientListView workflows={workflows} rows={rows} isAdmin={isAdmin} />
          </div>
        </main>
